...
class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        forecastAdapterViewHolder.weatherTempMin.setText(SunshineWeatherUtils.formatTemperature(mContext, lowInCelsius));
    }
    ...
    class ForecastAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ForecastAdapterViewHolder(View view) {
            ...
            weatherDay = (TextView) view.findViewById(R.id.date);
            weatherDescription = (TextView) view.findViewById(R.id.weather_description);
            weatherTempMax = (TextView) view.findViewById(R.id.high_temperature);
            weatherTempMin = (TextView) view.findViewById(R.id.low_temperature);
